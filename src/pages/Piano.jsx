...
const Piano = () => {
  ...
  const rugbyProducts = products.filter(product => product.category === 'Piano');
  
  console.log('All products:', products);
  console.log('Piano products:', pianoProducts);

  return (
    <>
      <Header />
      <div className="user-products-page">
        <h2>Piano Products</h2>
        <div className="products-grid">
          {pianoProducts.length === 0 && <p>No piano products available.</p>}
